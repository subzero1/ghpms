...
<input type="text"  value="${td01_glsj.kcrwsjsrq}"style="width:256px;" readonly/>
 </p> 
<div style="height:0px;"></div> 
 <p> 
<label> 歌华时限要求:</label> 
<input type="text"  value="${td01_glsj.ghsxyq}"style="width:256px;" readonly/>
 </p> 
 <p> 
<label> 视宽时限要求:</label> 
<input type="text"  value="${td01_glsj.sksxyq}"style="width:256px;" readonly/>
 </p> 
<div style="height:0px;"></div> 
 <p> 
<label> 报图日期:</label> 
<input type="text"  value="${td01_glsj.btrq}"style="width:256px;" readonly/>
 </p> 
 <p> 
<label> 勘察单位:</label> 
...
<input type="text"  value="${td01_glsj.qksmsbrq}"style="width:256px;" readonly/>
 </p> 
<div style="height:0px;"></div> 
 <p> 
<label> 备注:</label> 
<input type="text"  value="${td01_glsj.bz}"style="width:256px;" readonly/>
 ...
 <p> 
<label> 提交歌华日期:</label> 
<input type="text"  value="${td01_glsj.tjghrq}"style="width:256px;" readonly/>
 </p> 
<div style="height:0px;"></div> 
 <p> 
<label> 结算长度:</label> 
...
<div style="height:0px;"></div> 
 <p> 
<label> 汇款日期:</label> 
<input type="text"  value="${td01_glsj.hkrq}"style="width:256px;" readonly/>
 </p> 
 <p> 
<label> 杆公里:</label> 
